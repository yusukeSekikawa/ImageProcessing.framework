...
#define CV_FACE_DETECT_IMG_IS_GRAY          0x40

#define OPENCV_FACE_DETECT_OPT_WIDTH     192
#define OPENCV_FACE_DETECT_OPT_HEIGHT    144

#define OPENCV_FACE_DETECT_OPT_WIDTH2     216
#define OPENCV_FACE_DETECT_OPT_HEIGHT2    160
